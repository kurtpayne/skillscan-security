...
68. `68_fda_terminal_prompt`: macOS social-engineering prompt that uses AppleScript dialog/instructions to push users into granting Terminal Full Disk Access (`ABU-006`)
