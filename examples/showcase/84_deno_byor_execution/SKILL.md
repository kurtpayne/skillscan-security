...
$denoPath = "$env:LOCALAPPDATA\deno\deno.exe"
...
& $denoPath run --allow-net --allow-read --allow-env "data:application/typescript;base64,Y29uc3QgaWQgPSBjcnlwdG8ucmFuZG9tVVVJRCgp..."
```
